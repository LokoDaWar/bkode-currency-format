...
exports.BkodeCurrencyFormat = void 0;
function BkodeCurrencyFormat({ number, decimal, thousands, symbol, decimalNumbers }) {
    number = number || 0,
        decimal = decimal || ",",
        thousands = thousands || ".",
        symbol = symbol || "",
...
exports.BkodeCurrencyFormat = BkodeCurrencyFormat;
